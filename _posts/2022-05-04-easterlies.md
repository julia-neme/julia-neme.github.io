...
However, there is little to no research devoted to understanding projected changes in the Antarctic surface winds, usually referred to as "easterlies". In the context of a larger project that explores the sensitivity of the Antarctic margin to the easterlies, I analysed CMIP6[^1] models to quantify future changes until the end of the 21st Century. 
